...
<<boring-plots, fig.width=4, fig.height=4,fig.show='hold',out.width='.4\\linewidth'>>=
## two plots side by side (option fig.show='hold')
# is set in hook: par(mar=c(4,4,.1,.1),cex.lab=.95,cex.axis=.9,mgp=c(2,.7,0),tcl=-.3,las=1)
boxplot(x)
hist(x,main='')
@
...
\href{https://github.com/yihui/knitr/blob/master/inst/examples/knitr-minimal.Rnw}{link to Rnw}.
